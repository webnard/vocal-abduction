define(['Corpus'], function(Corpus) {
  ...
  function Console(language, graphicsPath) {
    ...
    function _getRandomSound() {
      ...
      return keys[_getRandomSound(0, keys.length)];
    };
    ...
    function _getRandomWord(sound) {
      ...
      return examples[_randBetween(0, examples.length)];
    };
     ...
     * @param word The word to show on the screen
     */
    ...
    (function _init() {
      ...
      _this.element.src  = graphicsPath + 'console.svg';
      _this.element.type = 'image/svg+xml';
    })();
